...
CREATE TABLE `accessoria` (
  ...
  `destinazione_uso` varchar(45) NOT NULL,
...
INSERT INTO `accessoria` VALUES ('lampada led','lettino',1),('poggia testa','poltrona',0),('rotolo','lettino',1),('scaldaletto','lettino',1),('vaporizzatore','letino',0);
...
-- Dump completed on 2022-10-24 15:16:46
